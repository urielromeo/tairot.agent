<script>
	...
	function onclick(event) {
		switch (action) {
			case 'open-telegram-bot':
				window.open('https://t.me/+z_Qbj70f-khkYzZk', '_blank');
				break;
			case 'open-x-account':
				window.open('https://x.com/TAROT_LORD', '_blank');
				break;
			case 'scroll-to-bribes':
				window.open('https://bribes.tairot.soniclords.com', '_blank');
				break;
			case 'open-git-repo':
				window.open('https://github.com/urielromeo/tairot.agent', '_blank');
				break;
			case 'open':
				// https://t.me/+z_Qbj70f-khkYzZk
...
<div
	class="pop3d {className} cta-div atkinson-hyperlegible-800"
